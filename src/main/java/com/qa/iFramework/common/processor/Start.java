...
public class Start {
    ...
    public static void main(String[] args){
        try {
            ...
            IVerifier verifier = (com.qa.iFramework.common.impl.VerifierImpl)context.getBean("verifier");
            IDataManager dataManager = (com.qa.iFramework.common.impl.DataManagerImpl)context.getBean("dataManager");
