...
import com.qa.iFramework.Entity.*;
...
public class CommandXml {
    ...
    public List<com.qa.iFramework.Entity.Userinfo> userList = new ArrayList<com.qa.iFramework.Entity.Userinfo>();//用户信息

    public static HashMap<String, com.qa.iFramework.Entity.Userinfo> userlistHm = new HashMap<String, com.qa.iFramework.Entity.Userinfo>();// 依赖参数
    ...
    public List<com.qa.iFramework.Entity.Userinfo> getUserList() {
        return userList;
    }

    public void setUserList(List<com.qa.iFramework.Entity.Userinfo> userList) {
